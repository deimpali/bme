 ...
 * <ul>
 *   <li>{@link petrinet.model.petri.impl.PetriNetImpl#getTransitions <em>Transitions</em>}</li>
 *   <li>{@link petrinet.model.petri.impl.PetriNetImpl#getPlaces <em>Places</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PetriNetImpl extends MinimalEObjectImpl.Container implements PetriNet {
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentEList<Transition>(Transition.class, this, PetriPackage.PETRI_NET__TRANSITIONS);
		}
		return transitions;
	}
	...
	public EList<Place> getPlaces() {
		if (places == null) {
			places = new EObjectContainmentEList<Place>(Place.class, this, PetriPackage.PETRI_NET__PLACES);
		}
		return places;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetriPackage.PETRI_NET__TRANSITIONS:
				return ((InternalEList<?>)getTransitions()).basicRemove(otherEnd, msgs);
			case PetriPackage.PETRI_NET__PLACES:
